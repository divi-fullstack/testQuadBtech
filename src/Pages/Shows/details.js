                      ...
                      <table className="table mb-0 text-nowrap text-wrap-table">
                        ...
                        <tbody>
                              ...
                              <tr>
                                ...
                                <td className="align-middle border-top-0">
                                 <button className="btn btn-primary btn-sm m-2 w-100"  onClick={()=>navigate("/book-ticket")}>Book Movie Ticket</button>
                                 <button className="btn btn-dark btn-sm w-100 m-2" onClick={()=>navigate("/")}>Back</button>
                                </td>
